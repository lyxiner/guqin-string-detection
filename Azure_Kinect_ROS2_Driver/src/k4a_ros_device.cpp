                                                ...
                                                std::shared_ptr<sensor_msgs::msg::PointCloud2>&  point_cloud)
{
  ...
  const auto cloud_width = pointcloud_image.get_width_pixels();
  const auto cloud_height = pointcloud_image.get_height_pixels();
  ...
  point_cloud->width = cloud_width;
  point_cloud->height = cloud_height;
